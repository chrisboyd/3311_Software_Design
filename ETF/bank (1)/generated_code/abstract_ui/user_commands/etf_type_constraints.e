...
feature -- query on declarations of event parameters
	evt_param_types_table : HASH_TABLE[HASH_TABLE[ETF_PARAM_TYPE, STRING], STRING]
		...
		do
			...
			new_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("ID", create {ETF_STR_PARAM}), "a_id")
			Result.extend (new_param_types, "new")
			create deposit_param_types.make (10)
			deposit_param_types.compare_objects
			deposit_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("ID", create {ETF_STR_PARAM}), "a_id")
			deposit_param_types.extend (create {ETF_VALUE_PARAM}, "a_value")
			Result.extend (deposit_param_types, "deposit")
			create withdraw_param_types.make (10)
			withdraw_param_types.compare_objects
			withdraw_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("ID", create {ETF_STR_PARAM}), "a_id")
			withdraw_param_types.extend (create {ETF_VALUE_PARAM}, "a_value")
			Result.extend (withdraw_param_types, "withdraw")
			create transfer_param_types.make (10)
			transfer_param_types.compare_objects
			transfer_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("ID", create {ETF_STR_PARAM}), "id1")
			transfer_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("ID", create {ETF_STR_PARAM}), "id2")
			transfer_param_types.extend (create {ETF_VALUE_PARAM}, "a_value")
...
feature -- query on declarations of event parameters
	evt_param_types_list : HASH_TABLE[LINKED_LIST[ETF_PARAM_TYPE], STRING]
		...
		do
			...
			new_param_types.compare_objects
			new_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("ID", create {ETF_STR_PARAM}))
			Result.extend (new_param_types, "new")
			create deposit_param_types.make
			deposit_param_types.compare_objects
			deposit_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("ID", create {ETF_STR_PARAM}))
			deposit_param_types.extend (create {ETF_VALUE_PARAM})
			Result.extend (deposit_param_types, "deposit")
			create withdraw_param_types.make
			withdraw_param_types.compare_objects
			withdraw_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("ID", create {ETF_STR_PARAM}))
			withdraw_param_types.extend (create {ETF_VALUE_PARAM})
			Result.extend (withdraw_param_types, "withdraw")
			create transfer_param_types.make
			transfer_param_types.compare_objects
			transfer_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("ID", create {ETF_STR_PARAM}))
			transfer_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("ID", create {ETF_STR_PARAM}))
			transfer_param_types.extend (create {ETF_VALUE_PARAM})
			Result.extend (transfer_param_types, "transfer")
		end
