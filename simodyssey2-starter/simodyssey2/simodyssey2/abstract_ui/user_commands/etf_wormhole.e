...
feature -- command
	...
	wormhole
		...
		do
			...
			elseif not model.game_board.explorer.location.has_wormhole then
				model.set_error ("Explorer couldn't find wormhole at Sector:" + model.game_board.explorer.location.out)
			else
